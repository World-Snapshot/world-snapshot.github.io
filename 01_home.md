...
<img src="logo/WS_logo.png" alt="org_logo" style="height: 60px; border-radius: 6px;" />
<span><i><b>"Unify Computer Vision, Expand Computer Vision, Transcend Computer Vision."</b></i></span>
</div>
</div>
...
<div class="tabs"><span class="tab active" onclick="document.getElementById('selected-news').classList.add('active');document.getElementById('all-news').classList.remove('active');this.parentElement.querySelectorAll('.tab').forEach(e=>e.classList.remove('active'));this.classList.add('active');">News</span>&#8204;<span class="tab" onclick="document.getElementById('all-news').classList.add('active');document.getElementById('selected-news').classList.remove('active');this.parentElement.querySelectorAll('.tab').forEach(e=>e.classList.remove('active'));this.classList.add('active');">Roadmap</span></div>

<div id="selected-news" class="tab-content news active">
...
<div id="all-news" class="tab-content news">
